        ...
        <div class="tab-content">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        ...
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar5.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        ...
                                        <div class="text-truncate">
                                            ...
                                            <div class="avatar-list avatar-list-stacked mt-1">
                                                <img class="avatar xs rounded" src="${path}/static/web/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="Sean">
                                                <img class="avatar xs rounded" src="${path}/static/web/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="Martin">
                                                <img class="avatar xs rounded" src="${path}/static/web/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="Terry">
                                                <img class="avatar xs rounded" src="${path}/static/web/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="Michelle">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <a href="single-chat-2.html" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar1.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar2.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar3.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar4.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar6.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        ...
                                        <div class="text-truncate">
                                            ...
                                            <div class="avatar-list avatar-list-stacked mt-1">
                                                <img class="avatar xs rounded" src="${path}/static/web/images/xs/avatar7.jpg" data-toggle="tooltip" data-placement="top" title="Sean">
                                                <img class="avatar xs rounded" src="${path}/static/web/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title="Martin">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar10.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                                            <h6 class="text-truncate mb-0 me-auto">Michelle Green</h6>
                    ...
                    <li>
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar9.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                    ...
                    <li>
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <img class="avatar rounded-circle" src="${path}/static/web/images/xs/avatar8.jpg" alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
            ...
            <div class="tab-pane fade" id="nav-tab-contact" role="tabpanel">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <button class="btn btn-dark" type="button" data-toggle="modal" data-target="#InviteFriends">添加好友</button>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="nav-tab-pages" role="tabpanel">
                ...
                <div class="card border-0">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item border-0">
                            <a class="link" href="password-reset.html"><i class="zmdi zmdi-label-alt me-2"></i> Reset Password</a>
                        </li>
                        <li class="list-group-item border-0">
                            <a class="link" href="settings.html"><i class="zmdi zmdi-label-alt me-2"></i> Settings</a>
                        </li>
                        <li class="list-group-item border-0">
                            <a class="link" href="single-chat.html"><i class="zmdi zmdi-label-alt me-2"></i> Single Chat Room</a>
                        </li>
                        <li class="list-group-item border-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        <img src="${path}/static/web/images/xs/avatar6.jpg" data-toggle="tooltip" title="" alt="Avatar" class="rounded-circle avatar" data-original-title="Avatar Name">
                                        <div class="ms-3">
...
<script src="${path}/static/web/vendor/jquery/jquery-3.5.1.min.js" type="67ae01ba4dd2a59f70ab9427-text/javascript"></script>
<script src="${path}/static/web/vendor/bootstrap/js/bootstrap.bundle.min.js" type="67ae01ba4dd2a59f70ab9427-text/javascript"></script>

<script src="${path}/static/web/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="67ae01ba4dd2a59f70ab9427-text/javascript"></script>
